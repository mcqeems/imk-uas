...
function Hero() {
  ...
  return (
    <div className="relative h-dvh w-full overflow-hidden">
      ...
      <div id="hero-inside" className="absolute inset-0 flex items-center justify-center">
        <div ref={textHeaderRef} className="flex flex-col lg:flex-row gap-4">
          <div id="inspiration">
            <Inspiration className="text-white h-32 w-full" />
          </div>
          <div id="foundation">
            <Foundation className="text-white h-32 w-full" />
          </div>
        </div>
        <div>
          <p>Solusi Kepemimpinan Sekolah yang Inovatif dan Berdampak.</p>
        </div>
      </div>
    </div>
  );
